...
public class Loader {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Введите Ф.И.О, номер телефона через 8 или +7");
        ...
        while (true) {
            ...
            if (AddAndVerify.phonePattern(userInput)) {
                phone = userInput
                        .replaceFirst("\\+?\\d", "7")
                        .replaceAll("[^0-9]", "").trim()
                        .replaceAll("(\\d)(\\d{3})(\\d{3})(\\d{2})(\\d{2})", "+$1$2$3$4$5");
                    ...
                    if (account.containsValue(phone)) {
                        System.out.println("Телефон - " + phone
                                .replaceAll("(\\d)(\\d{3})(\\d{3})(\\d{2})(\\d{2})",
                                        "$1 ($2) $3-$4-$5") + " принадлежит абоненту: " + name);
                    }
                } catch (NullPointerException error) {
            ...
            try {
                ...
                account.putIfAbsent(name, phone);
